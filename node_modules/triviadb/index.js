 ...
 */
async function getQuestions({ amount, category, difficulty, type, token, encoding }){
    ...
    if(difficulty !== 'hard' && difficulty !== 'medium' && difficulty !== 'easy' && difficulty)
        throw new Error("difficulty must be hard, easy, medium, or null");
